...
dir_entries.each do |i|
	...
	# Save the tree with fossils.
	tree.to_newick(fileName = "#{res_dir}/#{i}/species.fossils.reconstructed.fbd_all.tre", branchLengths = "duration", labels = true, plain = false, includeEmpty = true, overwrite = true, verbose = true)
